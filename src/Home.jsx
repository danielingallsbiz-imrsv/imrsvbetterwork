...
const Home = ({ navigateToApply, navigateToLogin, navigateToAdmin, navigateToJournal }) => {
    ...
    return (
        <div className="portal-theme">
            <div className="tab-layout home-container no-scrollbar" style={{ background: 'var(--bg)' }}>
                ...
                <section className="hero-section" >
                    ...
                    >
                        <h1 className="hero-title" style={{ fontWeight: 800, lineHeight: 0.9, color: 'var(--ink)', letterSpacing: '-0.04em' }}>
                            <InteractiveText text="Participation" /><br />
                            <InteractiveText text="that restores." />
                        </h1>
                        <p className="hero-subtitle" style={{ color: 'var(--muted)', marginTop: '24px', letterSpacing: '0.2em', textTransform: 'uppercase', fontSize: '11px' }}>
